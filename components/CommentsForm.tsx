...
import {getCategories, submitComment} from '../services';
...
function CommentsForm({slug} : any) {
    ...
    const [formData, setFormData] = useState<FormData>({ name: '', email: '', comment: '', storeData: false });
    ...
    useEffect(() => {
        ...
        const initalFormData = {
            ...
            comment: window.localStorage.getItem('comment') as string,
            storeData: (window.localStorage.getItem('name') !== null || window.localStorage.getItem('email') !== null ),
        };
